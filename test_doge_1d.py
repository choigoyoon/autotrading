...
def fetch_bybit_klines(symbol='DOGEUSDT', interval='D', limit=1000):
    """Bybit에서 OHLCV 데이터 가져오기"""
...
# DOGE 데이터 수집
df = fetch_bybit_klines('DOGEUSDT', 'D', 1000)
