...
def fetch_doge_data(symbol='DOGE/USDT:USDT', timeframe='1d', days=1825):
    """
    ccxt로 DOGE 데이터 수집 (5년)
    """
...
# DOGE 데이터 수집
df = fetch_doge_data('DOGE/USDT:USDT', '1d', days=1825)
