...
print("="*100)
print("변곡점 캔들 진입 백테스트 (미래 데이터 없음)")
print("="*100)
...
if len(trades_df) == 0:
    ...
    # 저장
    trades_df.to_csv('backtest_inflection_no_lookahead_results.csv', index=False)
    print(f"\n✅ 결과 저장: backtest_inflection_no_lookahead_results.csv")
