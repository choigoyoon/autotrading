...
class TraceRunner:
    ...
    def op_SETUP_EXCEPT(self, state, inst): # -> None:
        ...
...
class State:
    """State of the trace
    """
    def __init__(self, bytecode, pc, nstack, blockstack) -> None:
        """
        Parameters
        ----------
    ...
    def make_block(self, kind, end, reset_stack=..., handler=...): # -> dict[str, BlockKind | Any | int]:
        """Make a new block
        """
        ...
