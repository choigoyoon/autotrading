...
def replace_vars_inner(node, vardict): # -> list[Any | list[Any] | tuple[Any | list[Any] | tuple[Any, ...] | Expr | Yield, ...] | Expr | Yield] | tuple[Any | list[Any] | tuple[Any, ...] | Expr | Yield, ...] | Expr | Yield:
    ...
...
def visit_vars_inner(node, callback, cbdata): # -> list[Any | list[Any] | tuple[Any | list[Any] | tuple[Any, ...] | Expr | Yield, ...] | Expr | Yield] | tuple[Any | list[Any] | tuple[Any, ...] | Expr | Yield, ...] | Expr | Yield:
    ...
...
def has_no_side_effect(rhs, lives, call_table): # -> bool:
...
def get_ir_of_code(glbls, fcode): # -> FunctionIR:
    """
