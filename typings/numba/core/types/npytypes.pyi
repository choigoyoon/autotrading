...
class Array(Buffer):
    ...
    @property
    def mangling_args(self): # -> tuple[str, list[cached_property | Any | str]]:
        ...
    ...
    @property
    def key(self): # -> tuple[cached_property | Any, cached_property | Any, cached_property | Any, bool, bool]:
        ...
...
class NestedArray(Array):
    ...
    @property
    def key(self): # -> tuple[cached_property | Any, Any]:
        ...
