...
class Number(Hashable):
    ...
    """
    def unify(self, typingctx, other): # -> Record | Boolean | Integer | Float | Complex | PyObject | UnicodeCharSeq | CharSeq | NPTimedelta | NPDatetime | NestedArray | None:
        """
...
class Literal(Type):
    ...
    @property
    def literal_type(self): # -> ByteArray | PyArray | Buffer | ExternalFunctionPointer | Opaque | Any | ExternalFunction | Module:
        ...
