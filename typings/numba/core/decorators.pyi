...
def generated_jit(function=..., cache=..., pipeline_class=..., **options): # -> Callable[..., FakeCUDAKernel] | FakeCUDAKernel | CUDADispatcher | FunctionType | Callable[..., Callable[..., FakeCUDAKernel] | FakeCUDAKernel | CUDADispatcher | FunctionType | Any]:
    """
