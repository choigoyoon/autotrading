...
from numba.core import debuginfo, utils
...
class BaseContext:
    ...
    def get_helper_class(self, typ, kind=...): # -> type[_]:
        """
        Get a helper class for the given *typ*.
        """
        ...
    
    def make_helper(self, builder, typ, value=..., ref=...): # -> _:
        """
    ...
    def make_data_helper(self, builder, typ, ref=...): # -> _:
        """
    ...
    def make_complex(self, builder, typ, value=...): # -> _:
        """
