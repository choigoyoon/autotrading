...
class TargetConfigurationStack:
    ...
    @classmethod
    def switch_target(cls, retarget: BaseRetarget): # -> _GeneratorContextManager[None, None, None]:
...
class _DispatcherBase(_dispatcher.Dispatcher):
    ...
    def typeof_pyval(self, val): # -> PyObject | ByteArray | PyArray | Buffer | ExternalFunctionPointer | Opaque | Any:
        """
...
class Dispatcher(serialize.ReduceMixin, _MemoMixin, _DispatcherBase):
    ...
    _impl_kinds = ...
    __numba__ = ...
    def __init__(self, py_func, locals=..., targetoptions=..., impl_kind=..., pipeline_class=...) -> None:
        """
        Parameters
        ----------
