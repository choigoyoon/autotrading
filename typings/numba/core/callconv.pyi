...
class BaseCallConv:
    ...
    def raise_error(self, builder, api, status): # -> None:
        """
...
class MinimalCallConv(BaseCallConv):
    ...
    def decorate_function(self, fn, args, fe_argtypes, noalias=...):
        """
...
error_models = ...
def create_error_model(model_name, context): # -> NumpyErrorModel | PythonErrorModel:
    """
