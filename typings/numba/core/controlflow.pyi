...
class CFGraph:
    ...
    def dominators(self): # -> cached_property:
        """
    ...
    def post_dominators(self): # -> cached_property:
        """
        Return a dictionary of {node -> set(nodes)} mapping each node to
    ...
    def immediate_dominators(self): # -> cached_property:
        """
    ...
    def dominance_frontier(self): # -> cached_property:
        """
        Return a dictionary of {node -> set(nodes)} mapping each node to
    ...
    def dominator_tree(self): # -> cached_property:
        """
        return a dictionary of {node -> set(nodes)} mapping each node to
    ...
    def exit_points(self): # -> cached_property:
        """
    ...
    def loops(self): # -> cached_property:
        """
    ...
    def topo_order(self): # -> cached_property:
        """
