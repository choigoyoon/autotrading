...
def create_events(fname, spec, args, kwds): # -> tuple[list[str | Any], list[str | Any]]:
    ...

def dotrace(*args, **kwds): # -> classmethod[Any, ..., Any] | staticmethod[..., Any] | property | Callable[..., classmethod[Any, ..., Any] | staticmethod[..., Any] | Any]:
