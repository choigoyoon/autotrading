...
class AbstractTemplate(FunctionTemplate):
    ...
    def get_template_info(self): # -> dict[str, str | Any | tuple[int, int]]:
        ...
...
class ConcreteTemplate(FunctionTemplate):
    ...
    def get_template_info(self): # -> dict[str, str | Any | tuple[str, str]]:
        ...
...
class _OverloadFunctionTemplate(AbstractTemplate):
    ...
    @classmethod
    def get_source_info(cls): # -> dict[str, str | Any | tuple[int, int]]:
...
def make_overload_template(func, overload_func, jit_options, strict, inline, prefer_literal=..., **kwargs): # -> type[_OverloadFunctionTemplate]:
    """
...
def make_intrinsic_template(handle, defn, name, kwargs): # -> type[_IntrinsicTemplate]:
    """
...
def make_overload_attribute_template(typ, attr, overload_func, inline, prefer_literal=..., base=..., **kwargs): # -> type[_OverloadAttributeTemplate]:
    """
...
def bound_function(template_key): # -> Callable[..., _Wrapped[..., Any, ..., BoundFunction]]:
    """
