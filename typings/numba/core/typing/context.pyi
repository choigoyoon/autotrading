...
class BaseContext:
    ...
    def resolve_getattr(self, typ, attr): # -> ByteArray | PyArray | Buffer | ExternalFunctionPointer | Opaque | Any | ExternalFunction | Module | None:
        """
    ...
    def resolve_module_constants(self, typ, attr): # -> ByteArray | PyArray | Buffer | ExternalFunctionPointer | Opaque | Any | ExternalFunction | Module | None:
        """
    ...
    def resolve_argument_type(self, val): # -> ByteArray | PyArray | Buffer | ExternalFunctionPointer | Opaque | Any:
        """
    ...
    def resolve_value_type_prefer_literal(self, value): # -> ByteArray | PyArray | Buffer | ExternalFunctionPointer | Opaque | Any | ExternalFunction | Module | Literal:
