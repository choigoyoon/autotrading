...
class AsNumbaTypeRegistry:
    ...
    def try_infer(self, py_type): # -> ByteArray | PyArray | Buffer | ExternalFunctionPointer | Opaque | Type | Optional | ListType | DictType | Set | NamedUniTuple | NamedTuple | UniTuple | Tuple | None:
        """
