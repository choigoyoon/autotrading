...
_cached_type_map = ...
def map_type(cffi_type, use_record_dtype=...): # -> Signature | RawPointer | CPointer | NestedArray | Record | Boolean | Integer | Float | Complex | PyObject | UnicodeCharSeq | CharSeq | NPTimedelta | NPDatetime | Any | NoneType:
    """
...
def map_struct_to_record_dtype(cffi_type): # -> Record | Boolean | Integer | Float | Complex | PyObject | UnicodeCharSeq | CharSeq | NPTimedelta | NPDatetime | NestedArray:
