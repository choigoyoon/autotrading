...
_struct_proxy_cache = ...
def create_struct_proxy(fe_type, kind=...): # -> type[_]:
    """
...
@contextmanager
def for_range_slice_generic(builder, start, stop, step): # -> Generator[tuple[_GeneratorContextManager[Any, None, None], _GeneratorContextManager[Any, None, None]], Any, None]:
    """
