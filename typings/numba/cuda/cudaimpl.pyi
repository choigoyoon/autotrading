...
from numba.cuda.types import CUDADispatcher, dim3, grid_group
...
def cuda_grid(context, builder, sig, args): # -> list[Any] | Constant:
    ...

@lower(cuda.gridsize, types.int32)
def cuda_gridsize(context, builder, sig, args): # -> Constant:
    ...
