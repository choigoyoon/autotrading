...
from numba.core.compiler_machinery import AnalysisPass, LoweringPass, register_pass
...
def compile_cuda(pyfunc, return_type, args, debug=..., lineinfo=..., inline=..., fastmath=..., nvvm_options=...):
    ...

@global_compiler_lock
def compile_ptx(pyfunc, args, debug=..., lineinfo=..., device=..., fastmath=..., cc=..., opt=...): # -> tuple[Any, Any]:
...
def compile_ptx_for_current_device(pyfunc, args, debug=..., lineinfo=..., device=..., fastmath=..., opt=...):
