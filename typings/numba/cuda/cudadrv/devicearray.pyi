...
class DeviceNDArrayBase(_devicearray.DeviceArray):
    ...
    @property
    def __cuda_array_interface__(self): # -> dict[str, tuple[int, ...] | tuple[int | Any, bool] | str | int | None]:
        ...
    ...
    @devices.require_context
    def copy_to_host(self, ary=..., stream=...): # -> ndarray[Any, Any] | NDArray[signedinteger[_NBitByte]]:
...
class DeviceNDArray(DeviceNDArrayBase):
    ...
    def __array__(self, dtype=...): # -> ndarray[Any, Any] | ndarray[Any, dtype[signedinteger[_NBitByte]]]:
        """
