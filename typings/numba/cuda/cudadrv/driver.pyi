...
def find_driver(): # -> CDLL | WinDLL | None:
    ...
...
class Driver:
    ...
    def __getattr__(self, fname): # -> _Wrapped[..., Any, ..., Any] | _Wrapped[..., NoReturn, ..., None]:
        ...
...
class Linker(metaclass=ABCMeta):
    ...
    @classmethod
    def new(cls, max_registers=..., lineinfo=..., cc=...): # -> CudaPythonLinker | CtypesLinker:
        ...
...
class CtypesLinker(Linker):
    ...
    def complete(self): # -> tuple[c_void_p, int]:
        ...
...
class CudaPythonLinker(Linker):
    ...
    def complete(self): # -> tuple[Any, Any]:
        ...
