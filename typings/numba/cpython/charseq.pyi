...
@register_jitable
def unicode_charseq_get_value(a, i): # -> Any:
...
def charseq_to_bytes(context, builder, fromty, toty, val): # -> _:
    ...

@lower_cast(types.UnicodeType, types.Bytes)
def unicode_to_bytes_cast(context, builder, fromty, toty, val): # -> _:
    ...
...
def charseq_getitem(s, i): # -> Callable[..., Any] | None:
    ...
...
@overload(str)
def charseq_str(s): # -> Callable[..., Any] | None:
    ...
