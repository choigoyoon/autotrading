...
@overload(str)
def unicode_str(s): # -> Callable[..., Any] | None:
    ...
...
def unicode_startswith(a, b): # -> Callable[..., bool] | None:
    ...
...
@overload(str)
def integer_str(n): # -> Callable[..., Any | Literal['0']] | None:
    ...

@overload(str)
def boolean_str(b): # -> Callable[..., Literal['True', 'False']] | None:
    ...
