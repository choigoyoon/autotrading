...
class CompilationCache:
    ...
    def compile(self, func, args, return_type=..., flags=...):
        """
...
class TestCase(unittest.TestCase):
    ...
    def run_nullary_func(self, pyfunc, flags): # -> tuple[Any, Any]:
        """
...
def tweak_code(func, codestring=..., consts=...): # -> None:
    """
...
def run_in_new_process_caching(func, cache_dir_prefix=..., verbose=...): # -> dict[str, int | Any | None]:
...
def run_in_new_process_in_cache_dir(func, cache_dir, verbose=...): # -> dict[str, int | Any | None]:
    """Spawn a new process to run `func` with a temporary cache directory.
