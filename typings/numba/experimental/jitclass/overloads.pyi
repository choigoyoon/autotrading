...
on an object.
"""
def class_instance_overload(target): # -> Callable[..., _Wrapped[..., Any, ..., Any | None]]:
    """
...
def register_simple_overload(func, *attrs, n_args=...): # -> _Wrapped[..., Any, ..., Any | None]:
    """
