...
def dot_2(context, builder, sig, args): # -> None:
    """
    np.dot(a, b)
    a @ b
    """
...
def dot_3(context, builder, sig, args): # -> None:
    """
    np.dot(a, b, out)
    """
    ...
...
def lstsq_impl(a, b, rcond=...): # -> Callable[..., tuple[NoReturn, NDArray[bool_ | object_ | void], Any, ndarray[Any, dtype[bool_ | object_ | void]]]]:
    ...
...
def norm_impl(a, ord=...): # -> Callable[..., NoReturn] | None:
    ...

@overload(np.linalg.cond)
def cond_impl(a, p=...): # -> Callable[..., float | Any | floating[Any]]:
    ...
