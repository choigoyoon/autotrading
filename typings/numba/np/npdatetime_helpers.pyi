...
def get_datetime_timedelta_conversion(datetime_unit, timedelta_unit): # -> tuple[Any, Literal[1], Literal[1]] | tuple[Any, int, Literal[400, 2800, 1, 4800, 33600]] | tuple[Any, Literal[146097, 1], int]:
    """
