...
def zero_dim_msg(fn_name): # -> str:
    ...

@overload(_is_nat)
def ol_is_nat(x): # -> Callable[..., Any]:
    ...
...
def array_argmin(arr, axis=...): # -> Callable[..., int]:
    ...
...
def build_argmax_or_argmin_with_axis_impl(arr, axis, flatten_impl): # -> Callable[..., Any]:
    """
...
def array_argmax(arr, axis=...): # -> Callable[..., int]:
    ...
...
@overload(np.average)
def np_average(arr, axis=..., weights=...): # -> Callable[..., floating[Any]]:
    ...
...
def np_isscalar(num): # -> Callable[..., bool]:
    ...
...
def np_nancumprod(a): # -> Callable[..., Any] | None:
    ...

@overload(np.nancumsum)
def np_nancumsum(a): # -> Callable[..., NDArray[Any]] | Callable[..., Any] | None:
    ...
...
@overload(np.tri)
def np_tri(N, M=..., k=...): # -> Callable[..., NDArray[floating[_64Bit]]]:
    ...
...
@register_jitable
def np_interp_impl_complex_fp_inner(x, xp, fp, dtype): # -> NDArray[Any] | NDArray[float64]:
    ...

def np_interp_impl_complex_fp_inner_factory(np117_nan_handling): # -> Callable[..., NDArray[Any] | NDArray[float64]]:
    ...
...
def np_interp_impl_inner_factory(np117_nan_handling): # -> Callable[..., NDArray[Any] | NDArray[float64]]:
    ...

np_interp_impl_inner_post_np117 = ...
np_interp_impl_complex_inner_post_np117 = ...
np_interp_impl_inner_pre_np117 = ...
np_interp_impl_complex_inner_pre_np117 = ...
@overload(np.interp)
...
array_scalar_scalar_where = ...
array_array_scalar_where = ...
array_scalar_array_where = ...
@glue_lowering(np.where, types.Any, types.Any, types.Any)
def any_where(context, builder, sig, args):
    ...

@overload(np.real)
def np_real(a): # -> Callable[..., Any]:
    ...

@overload(np.imag)
def np_imag(a): # -> Callable[..., Any]:
    ...
...
def np_count_nonzero(arr, axis=...): # -> Callable[..., Any]:
    ...
...
def np_array_equal(a, b): # -> Callable[..., Any]:
    ...

@overload(np.intersect1d)
def jit_np_intersect1d(ar1, ar2): # -> Callable[..., Any]:
    ...
...
def searchsorted(a, v, side=...): # -> Callable[..., NDArray[signedinteger[_NBitIntP]]]:
    ...

@overload(np.digitize)
def np_digitize(x, bins, right=...): # -> Callable[..., NDArray[signedinteger[_NBitIntP]]] | None:
    ...
...
_iinfo_supported = ...
iinfo = ...
def generate_xinfo(np_func, container, attr): # -> None:
    ...
...
def np_convolve(a, v): # -> Callable[..., None]:
    ...
...
def window_generator(func): # -> Callable[..., Callable[..., NDArray[floating[_NBitDouble]] | Any]]:
    ...
...
@overload(np.kaiser)
def np_kaiser(M, beta): # -> Callable[..., NDArray[floating[_NBitDouble]]]:
    ...

@overload(np.cross)
def np_cross(a, b): # -> Callable[..., Callable[..., NDArray[Any]]]:
    ...

@generated_jit
def cross2d(a, b): # -> Callable[..., NDArray[Any]]:
    ...
