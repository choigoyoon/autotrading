...
re_datetimestr = ...
sizeof_unicode_char = ...
def from_dtype(dtype): # -> Record | Boolean | Integer | Float | Complex | PyObject | UnicodeCharSeq | CharSeq | NPTimedelta | NPDatetime | NestedArray:
    """
...
def map_arrayscalar_type(val): # -> Record | Boolean | Integer | Float | Complex | PyObject | UnicodeCharSeq | CharSeq | NPTimedelta | NPDatetime | NestedArray:
    ...
