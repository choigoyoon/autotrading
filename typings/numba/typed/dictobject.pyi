...
from numba.core.extending import lower_builtin, lower_cast, models, overload, overload_method, register_model
...
def new_dict(key, value): # -> dict[Any, Any]:
...
@overload(new_dict)
def impl_new_dict(key, value): # -> Callable[..., Any]:
