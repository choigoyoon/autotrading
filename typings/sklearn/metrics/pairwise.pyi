...
@validate_params({ "X": ["array-like", "sparse matrix"],"Y": ["array-like", "sparse matrix"],"axis": [Options(Integral, 0, 1)],"metric": [StrOptions(set(_VALID_METRICS).union(ArgKmin.valid_metrics())), callable],"metric_kwargs": [dict, None] }, prefer_skip_nested_validation=False)
def pairwise_distances_argmin(X, Y, *, axis=..., metric=..., metric_kwargs=...): # -> NDArray[bool_ | float64]:
    """Compute minimum distances between one point and a set of points.
...
def pairwise_distances_chunked(X, Y=..., *, reduce_func=..., metric=..., n_jobs=..., working_memory=..., **kwds): # -> Generator[Any | NDArray[Any] | NDArray[bool_] | NDArray[floating[Any]] | NDArray[float64], Any, None]:
...
def pairwise_distances(X, Y=..., metric=..., *, n_jobs=..., force_all_finite=..., ensure_all_finite=..., **kwds): # -> NDArray[Any] | NDArray[bool_] | NDArray[floating[Any]] | Any | NDArray[float64]:
...
def pairwise_kernels(X, Y=..., metric=..., *, filter_params=..., n_jobs=..., **kwds): # -> NDArray[bool_] | NDArray[Any] | Any | NDArray[float64] | None:
