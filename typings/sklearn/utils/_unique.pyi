...
def attach_unique(*ys, return_tuple=...): # -> ndarray[Any, dtype[Any]] | NDArray[Any] | tuple[Any | ndarray[Any, dtype[Any]] | NDArray[Any], ...] | tuple[Any | ndarray[Any, dtype[Any]] | NDArray[Any]]:
