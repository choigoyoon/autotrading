...
class LabelBinarizer(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    def fit_transform(self, y): # -> csr_matrix | NDArray[unsignedinteger[Any]]:
    ...
    def transform(self, y): # -> csr_matrix | NDArray[unsignedinteger[Any]]:
...
def label_binarize(y, *, classes, neg_label=..., pos_label=..., sparse_output=...): # -> csr_matrix | NDArray[unsignedinteger[Any]]:
    """Binarize labels in a one-vs-all fashion.
