...
def normalize(X, norm=..., *, axis=..., copy=..., return_norm=...): # -> tuple[Any, Any | float | generic | bool | int | complex | str | bytes | memoryview[int]]:
...
class Normalizer(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X, copy=...): # -> tuple[Any, Any | float | generic | bool | int | complex | str | bytes | memoryview[int]]:
