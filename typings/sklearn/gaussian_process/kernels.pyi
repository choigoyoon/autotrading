...
class RBF(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[Any], NDArray[float64]] | tuple[NDArray[Any], ndarray[Any, dtype[bool_]]] | tuple[NDArray[Any], Any] | NDArray[Any] | None:
        """Return the kernel k(X, Y) and optionally its gradient.
