...
def ward_tree(X, *, connectivity=..., n_clusters=..., return_distance=...): # -> tuple[Any, Literal[1], int, None, Any] | tuple[Any, Literal[1], int, None] | tuple[NDArray[Any], Any, int, NDArray[signedinteger[_NBitIntP]], NDArray[Any]] | tuple[NDArray[Any], Any, int, NDArray[signedinteger[_NBitIntP]]]:
...
def linkage_tree(X, connectivity=..., n_clusters=..., linkage=..., affinity=..., return_distance=...): # -> tuple[Any, Literal[1], int, None, Any] | tuple[Any, Literal[1], int, None] | tuple[Any, Any, int, NDArray[signedinteger[_NBitIntP]], Any] | tuple[Any, Any, int, NDArray[signedinteger[_NBitIntP]]] | tuple[ndarray[Any, dtype[Any]], Any, int, NDArray[signedinteger[_NBitIntP]], NDArray[float64] | Any | None] | tuple[ndarray[Any, dtype[Any]], Any, int, NDArray[signedinteger[_NBitIntP]]]:
